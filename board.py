...
class Board():
    ...
    def __init__(self, s_game):
        ...
        self.color_2 = pygame.Color('royalblue')
    ...
    def prep_board(self):
        self.board = pygame.image.load("img/ScrabbleBoard.bmp")
        self.board_rect = self.board.get_rect()
        self.board_rect.center = self.screen_rect.center

    def prep_hud(self):
        #HUD Board
        self.hud = pygame.image.load("img/HUD.bmp")
    ...
    def draw_board(self):
        ...
        self.screen.blit(self.hud, self.hud_rect)
